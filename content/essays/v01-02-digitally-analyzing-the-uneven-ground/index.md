...
![A histogram showing the frequency of language borrowing over different spans of time](figure1.png)
{{< /figure >}}
...
![A chart showing side-by-side comparison of the language used in the eighteen hundred and four Fox Treaty and the eighteen hundred and eight Osage Treaty](figure2.png)
{{< /figure >}}
...
![Network graph that shows the language borrowing that occurred between treaties over time](figure3.png)
{{< /figure >}}
...
![Series of maps showing language borrowing networks based upon the location of negotiation by decade](figure4.png)
{{< /figure >}}
...
![Series of maps showing language borrowing networks based upon the location impacted by the treaty by decade](figure5.png)
{{< /figure >}}
...
![A chart showing side-by-side comparison of the language used in the seventeen hundred and eighty-nine Treaty at Fort Harmar and the eighteen hundred and four Comanche Treaty](figure6.png)
{{< /figure >}}
...
![Network graph showing that the eighteen hundred and forty six Comanche Treaty is the only treaty in borrowing cluster from the eighteen hundred and forties](figure7.png)
{{< /figure >}}
...
![A chart showing side-by-side comparison of the language used in the seventeen hundred and eighty-nine Treaty at Fort Harmar and the eighteen hundred and forty-six Comanche Treaty](figure8.png)
{{< /figure >}}
...
![A chart showing side-by-side comparison of the language used in the seventeen hundred and ninety-five Treaty of Greenville and the eighteen hundred and forty-six Comanche Treaty](figure9.png)
{{< /figure >}}
...
![Network graph of language borrowing which highlights treaties negotiated with the Ojibwe](figure10.png)
{{< /figure >}}
...
![Networking showing the Manypenny cluster and the the subsequent documents that his work influenced](figure11.png)
{{< /figure >}}
...
![A chart showing side-by-side comparison of the language used in the seventeen eighteen hundred and fifty-five Chippewa Treaty and the eighteen hundred and fifty-five Winnebago Treaty](figure12.png)
{{< /figure >}}
...
![A map showing treaties by location of negotiation. Treaties that did not borrow language from other agreements are higlighted in red.](figure13.png)
{{< /figure >}}
...
![A map showing language borrowing in treaties by location of impact. Treaties that explicitly granted fishing rights are highlighted in blue.](figure14.png)
{{< /figure >}}
...
![A map showing language borrowing in treaties by location of negotiation. Treaties that explicitly granted fishing rights are highlighted in blue.](figure15.png)
{{< /figure >}}
