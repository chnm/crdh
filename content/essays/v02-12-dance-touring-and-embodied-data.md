...
![Graph showing the number of nights Dunham stayed in particular cities such as Paris, Los Angles, Port-au-Prince, London, Buenos Aires, Rome, New York City, and Rio de Janeiro during the years nineteen fifty to nineteen fifty-three.](/img/v02/bench/figure2.png)
{{< /figure >}}
...
{{< figure caption="Figure 3. Frequency of nights stayed, 1950--53. This box plot visualizes the distribution of Dunham's stay lengths. The normal distribution is 1 to 14 nights, with a maximum normal value of 30 nights. Longer stays are outliers. The median distribution is a stay of 5 nights, with 31% of her stays lasting a single night. Data: Harmony Bench and Kate Elswit; Visualization: Antonio Jiménez Mavillard." >}}
![Box plot and bar graph showing the distribution of Dunham’s stay lengths during the years nineteen fifty to nineteen fifty-three.](/img/v02/bench/figure3.png)
{{< /figure >}}
