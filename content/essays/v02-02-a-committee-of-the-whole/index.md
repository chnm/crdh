...
![Network graph on a black background titled "Six groups of Colored Conventions, 1830-64," showing convention nodes color-coded into six clusters (Northeast, Midwest, Ohio, Indiana, Pennsylvania, and West Coast) connected by dense webs of colored edges indicating shared delegates or attendance links.](figure1.png)
{{< /figure >}}
...
![Two network graphs on black backgrounds, labeled "Pennsylvania Cluster" and "Northeastern Cluster," each showing large glowing nodes for UGRR and ASC connected by dense lines to smaller regional nodes.](figure2.png)
{{< /figure >}}
...
![Two network graphs on black backgrounds labeled "Transnational Cluster" and "California Cluster," each with colored node clusters (UGRR, ASC, Transnational, California) connected by radiating lines of varying density.](figure3.png)
{{< /figure >}}
...
![Two network graphs on black backgrounds: one connects nodes labeled UGRR, ASC, and Border States, the other shows a large "Maryland" node linked by lines to numerous smaller nodes each labeled with a person's name.](figure4.png)
{{< /figure >}}
...
![Two side-by-side network diagrams on black backgrounds, labeled "Pennsylvania Cluster" and "Northeastern Cluster," showing colored nodes for organizations like ASC, UGRR, and Pennsylvania connected by lines to dozens of individual names and dated events.](figure6.png)
{{< /figure >}}
...
![Two network diagrams on black backgrounds labeled "Transnational Cluster, Degree 2+" and "California Cluster, Degree 2+," with lines connecting UGRR and ASC nodes to dozens of labeled activists and dated events.](figure7.png)
{{< /figure >}}
...
![Two side-by-side network diagrams on black backgrounds showing labeled individuals connected by colored lines to large ASC and UGRR nodes, one highlighting a "Border States" cluster and the other a "Maryland" cluster.](figure8.png)
{{< /figure >}}
...
![Two network graphs on black backgrounds, labeled "Pennsylvania Cluster, Degree 3+" and "Northeastern Cluster, Degree 3+," showing colored nodes for figures like Frederick Douglass and William Howard Day connected by lines to organizational hubs such as UGRR, ASC, and Pennsylvania or Northeast.](figure9.png)
{{< /figure >}}
...
![Two black-background network diagrams on black backgrounds: left, a "Transnational Cluster" graph linking figures like Frederick Douglass, John Brown, and Samuel Ringgold Ward to nodes labeled UGRR and ASC; right, a "California Cluster" graph clustering Douglass, Robert Purvis, and others around a large UGRR node with scattered unconnected dots.](figure10.png)
{{< /figure >}}
...
![Network diagram titled "Border State Cluster, Degree 3+," with nodes for figures like Frederick Douglass, Martin R. Delany, and James Poindexter connected to hubs labeled BorderStates, ASC, and UGRR.](figure11.png)
{{< /figure >}}
