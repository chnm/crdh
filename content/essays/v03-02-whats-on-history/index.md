...
![Horizontal bar graph for each of the twelve topics in the model, showing the most common words in each topic.](figure1.png)
{{< /figure >}}
...
![Horizontal bar graph in green of the top sixty most common words.](figure2.png)
{{< /figure >}}
...
![Vertical bar graph showing the number of episodes of each show which aired on History during the study period.](figure3.png)
{{< /figure >}}
...
![Screenshot from History's webpage for the show Ancient Aliens.](figure5.png)
{{< /figure >}}
...
![Screenshot from History's webpage for the show Forged in Fire.](figure6.png)
{{< /figure >}}
