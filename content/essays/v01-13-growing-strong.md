...
![Network graph showing connections between early American societies and groups in nine different catagories](/img/v01/oberle/network.png)
{{< /figure >}}
...
![A bar graph showing the number of federal employees based in Washington D.C. that were members of certian learned societies.](/img/v01/oberle/federal-employees.png)
{{< /figure >}}
