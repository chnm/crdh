...
![Horizontal bar graph for each of the twelve topics in the model, showing the most common words in each topic.](/img/v03/catalano-pocratsky/figure1.png)
{{< /figure >}}
...
![Vertical bar graph showing the number of episodes of each show which aired on History during the study period.](/img/v03/catalano-pocratsky/figure3.png)
{{< /figure >}}
...
![Screenshot from History's webpage for the show Ancient Aliens.](/img/v03/catalano-pocratsky/figure5.png)
{{< /figure >}}
...
![Screenshot from History's webpage for the show Forged in Fire.](/img/v03/catalano-pocratsky/figure6.png)
{{< /figure >}}
