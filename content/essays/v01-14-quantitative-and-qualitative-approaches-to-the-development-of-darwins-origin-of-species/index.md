...
![Violin plot titled "Perplexity of The Origin's sample clusters," showing eight topic clusters (T49–T177) with sample sizes and top keywords like pigeons, negroes, forests, and Egyptian races plotted against perplexity scores.](perplexity.png)
{{< /figure >}}
...
![Line chart titled "Divergence between Darwin's readings and writings," plotting KL divergence over reading dates from 1837 to 1859 for three texts (1842 Sketch, 1844 Essay, Origin), all trending downward from around 5-8 to 3-4.](divergence.png)
{{< /figure >}}
...
![Two heatmaps titled "JSD between Wallace and Darwin's writings," showing Jensen-Shannon divergence scores comparing Wallace's texts to Darwin's Sketch of '42, Essay of '44, and Origin (1st ed), with values ranging roughly 0.43 to 0.73 in orange, red, and yellow shading.](jsd.png)
{{< /figure >}}
