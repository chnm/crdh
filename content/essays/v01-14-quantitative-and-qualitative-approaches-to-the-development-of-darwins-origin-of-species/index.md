...
![Violin plot titled "Perplexity of The Origin's sample clusters," showing eight topic clusters (T49–T177) plotted by perplexity value, each labeled with sample size and top associated keywords.](perplexity.png)
{{< /figure >}}
...
![Line chart titled "Divergence between Darwin's readings and writings," plotting KL divergence over reading dates from 1838–1860, with three colored lines tracking the 1842 Sketch, 1844 Essay, and Origin texts, each trending downward and marked by a dashed vertical line.](divergence.png)
{{< /figure >}}
...
![Two heatmaps of Jensen-Shannon Divergence scores comparing Wallace's writings against Darwin's drafts, showing values from 0.43 to 0.73 in orange, red, and yellow shading.](jsd.png)
{{< /figure >}}
