...
![Scan of a manuscript title page in French cursive script reading "Inventaire des Tableaux du Cabinet du Roy," dated July 1683, with archival stamps and reference numbers.](figure1.jpeg)
{{< /figure >}}
...
![Installation view of the "Tell Me of Louis" exhibition: two gallery walls each hung with a long horizontal strip of small reproduction paintings scaled down and arranged in a row, with two low plinths in the foreground.](figure2.jpeg)
{{< /figure >}}

{{< figure caption="Fig. 3: Iconography Tables." >}}
![First half of a dense, color-coded spreadsheet cataloguing the 931 Versailles paintings, with columns for source, attribution, location, date, and iconographic classification.](figure3a.jpeg)![Second half of the same color-coded spreadsheet, continuing the catalogue of paintings with their iconographic classification and related attributes.](figure3b.jpeg)
{{< /figure >}}
...
![Paolo Veronese's painting "Esther before Ahasuerus": Esther and two attendants approach an enthroned king surrounded by courtiers, set within a classical colonnaded interior.](figure4.jpeg)
{{< /figure >}}
...
![Horizontal bar chart listing painters such as Francesco Albani, Nicolas Poussin, and Paolo Veronese, each with two bars comparing their number of paintings to their total painted area in square centimeters.](figure5.jpeg)
{{< /figure >}}
...
![1701 architectural floor plan of the first floor of the Château de Versailles, with rooms numbered 1 through 16 keyed to a legend naming spaces from the Escalier de la Reine to the Cabinet des Medailles.](figure6.jpeg)
{{< /figure >}}
...
![Two-page spread from Piganiol de La Force's 1707 guidebook: an engraved bird's-eye view of Versailles on the left, facing the book's title page, "Nouvelle Description des Chasteaux et Parcs de Versailles et de Marly," on the right.](figure7.jpeg)
{{< /figure >}}
...
![Horizontal bar chart titled "Versailles, Area and Number of paintings," comparing the percentage share of painting count against percentage share of coverage area across the nine Iconclass categories.](figure8.jpeg)
{{< /figure >}}
...
![Horizontal bar chart titled "Versailles, Number of paintings produced before and after 1654," comparing painting counts before and after that year across the nine Iconclass categories.](figure9.jpeg)
{{< /figure >}}
...
![Horizontal bar chart titled "Versailles, Share of paintings produced before and after 1671," comparing the percentage share of paintings before and after that year across the nine Iconclass categories.](figure10.jpeg)
{{< /figure >}}
...
![Line chart tracking the number of active painters by national school from 1300 to 1900, with peaks labeled for Italian, Dutch, Flemish, French, British, German, Habsburg, Danish, Swedish, and Polish schools, and the reigns of Francis I and Louis XIV highlighted.](figure11.jpeg)
{{< /figure >}}
...
![Horizontal bar chart titled "Appartement du Roi, Relationship between the number and coverage area by national school," comparing Italian, French, Flemish, and German paintings by percentage of count and of painted area.](figure12.jpeg)
{{< /figure >}}
...
![Horizontal bar chart comparing the percentage share of paintings by Iconclass category between all of Versailles and the Appartement du Roi alone, showing Biblical iconography disproportionately represented in the Appartement.](figure13.jpeg)
{{< /figure >}}

{{< figure caption="Fig. 14: Versailles vs Appartement du Roi AREA by Iconography." >}}
![Horizontal bar chart comparing painted area by Iconclass category between all of Versailles and the Appartement du Roi alone, showing Biblical iconography covering a much larger area share within the Appartement.](figure14.jpeg)
{{< /figure >}}
