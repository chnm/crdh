...
{{< figure caption="Figure 1: Christian IV`s writing room on the ground floor of one of the towers of Rosenborg Castle © Photograph by Marie Thérèse Hébert & Jean Robert Thibault, 25 May 2016. Licensed under CC BY-SA 2.0. Via Wikimedia Commons" >}}![photograph of an arnate desk with many carvings and a chair infront of it](figure1.png)
{{< /figure >}}
...
{{< figure caption="Figure 2: a letter written by Christian IV and signed with D'ronningborre Slott den 4 Maÿ Anno D(omi)ni 1610 Christian'. © Rigsarkivet København, Kongehuset Christian 4., Christian 4.s egenhændige breve." >}}![photograph of a hnadwritten docuemtn with text sprawling msot of the page](figure2.png)
{{< /figure >}}
...
{{< figure caption="Figure 3: A map indicating the location from where the letters were written. This shows the mobility of Christian IV throughout the Danish territory." >}}![digital map of europe shwoing brown dots indicating locations for letters](figure3.png)
{{< /figure >}}
...
{{< figure caption="Figure 4: The same locations with the size of the dots adjusted to represent the number of letters written from a certain location. A bigger dot means that more letters were sent from a specific location and that Christian IV spent a significant amount of time here, making these sites important in his itinerary." >}}![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density. The largest orange circles cluster around København and Kronborg in the northeast, with additional labeled sites including Frederiksborg, Odense, Rendsborg, Glückstadt, Stade, and Wolfenbüttel, plus a distance scale bar and inset locator map in the bottom right corner showing the region's position within Europe.](figure4.png)
{{< /figure >}}
...
![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density. The map centers on the Jutland peninsula and Danish straits, with labeled points at Bohus, Göteborg, Randers, Haderslev, Engelholm, København, and Schwerin spanning from southern Sweden down through Denmark to northern Germany, accompanied by a scale bar marking 200 kilometers.](figure5a.png)
![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density. The largest dot marks Haderslev in the Jutland peninsula and a similarly large dot marks København, while Frederiksborg, Kronborg, Celle, Wolfenbüttel, and Rotenburg appear as smaller dots scattered across present-day Denmark and northern Germany, with a scale bar showing 0 to 200 km in the lower left corner.](figure5b.png)
![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density. The largest dot marks Frederiksborg, while eleven smaller labeled dots—including Rotenburg to the south, Rheinsberg to the east, and Verden—cluster mainly across Denmark and northern Germany with a scale bar showing 0 to 200 km in the lower left corner.](figure5c.png)
![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density. The largest dots cluster around Copenhagen and Frederiksborg in Denmark, with the next-largest concentrations near Stade and Wolfenbüttel in northern Germany, and a scale bar in the lower left marking distances up to 200 km.](figure5d.png)
![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density. The largest cluster sits along the Jutland-Schleswig coastline near Rendsborg and Glücksburg, with a 200-kilometer scale bar in the lower left and labeled points also including Haderslev, Glückstadt, Frederiksborg, København, and Nykøbing on the Danish islands to the east.](figure5e.png)
![a digital map of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density](figure5f.png)
{{< /figure >}}
...
{{< figure caption="Figure 6: A map of the locations mentioned in the body text of the letters of Christian IV. A larger area of Europe is now covered, including England and Spain" >}}![a larger digital map covering more area of europe showing orange dots indicating location that are also labeled with european cities. the dots are of various sizes to indicate density](figure6.png)
{{< /figure >}}
...
{{< figure caption="Figure 7: Some of the most important building sites of Christian IV" >}}![a digital map of europe showing maroon dots indicating locations](figure7.png)
{{< /figure >}}
