...
![A regional map of southern Scandinavia and northern Germany with a scale bar, marking Bohus, Göteborg, Randers, Haderslev, København, Engelholm, and Schwerin with orange dots.](figure5a.png)
![Map of Denmark and northern Germany with orange circles of varying size marking Copenhagen, Kronborg, Frederiksborg, Kolding, Haderslev, Celle, Wolfenbüttel, and Rotenburg, with a scale bar showing kilometers.](figure5b.png)
![Map of Denmark and northern Germany with orange circles of varying sizes marking locations including Frederiksborg, Kronborg, København, Nyborg, Glückstadt, Lauenburg, Nienburg, and Rotenburg, sized to indicate relative importance or frequency.](figure5c.png)
![A map of Denmark and northern Germany with orange proportional circles sized by value clustered around Copenhagen, Frederiksborg, Dalum, Stade, and Wolfenbüttel, with smaller dots scattered further south.](figure5d.png)
![A map of Denmark and surrounding Baltic coastline with orange circles of varying sizes marking locations including København, Frederiksborg, Nykøbing, Rendsborg, Haderslev, Glücksburg, and Glückstadt, with a scale bar showing 0–200 km.](figure5e.png)
![Map of Denmark and surrounding Scandinavian coastline with orange proportional circles clustered near Copenhagen and Frederiksborg, indicating varying concentrations at those and nearby locations, with a scale bar in kilometers.](figure5f.png)
{{< /figure >}}
