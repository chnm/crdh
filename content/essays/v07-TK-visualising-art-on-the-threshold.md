...
{{< figure caption="Figure 1. Filippo Lippi, *The Annunciation*, c.1450-53. Egg tempera on wood, 68.6 x 152.7cm. The National Gallery, London (NG666).© The National Gallery, London" >}}![Filippo Lippi, The Annunciation, Egg tempra on wood.](/img/v07/McGee/figure1.png)
{{< /figure >}}
...
particularly in the years following the palazzo's purchase by the
...
The liminal symbolism of Lippi's *Annunciation* would also have had a
...
{{< figure caption="Figure 3. Dynamic digital model of Lippi's *Annunciation* as an overdoor. Made by author using Autodesk Maya. Image of *Annunciation* (see figure 1) © The National Gallery, London." >}}![Dynamic digial model of Lippi's Annunciation.](/img/v07/McGee/figure3.png)
{{< /figure >}}
...
{{< figure caption="Figure 4. Still from the dynamic digital model of Lippi’s *Annunciation* as an overdoor (see figure 3), to show a possible view of the painting when looking up before crossing the threshold." >}}![Still from Dynamic digial model of Lippi's Annunciation.](/img/v07/McGee/figure4.png)
{{< /figure >}}
...
Only then might this work be harnessed for the museum public, probably
