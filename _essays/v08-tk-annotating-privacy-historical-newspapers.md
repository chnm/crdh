...
![TK]({{site.url}}/assets/img/v07/perez/figure1a.png)
![TK]({{site.url}}/assets/img/v07/perez/figure1b.png)
{% endfigure %}

Fricke purposefully left the OCR errors in the material she annotated for Borenstein to evaluate how the model would perform in real life conditions, where OCR errors are common.
...
There were three pressing challenges that our research team must face as we advance our project:
