...
{% figure caption: "Figure 5: Visualization of the correspondence split up into relative periods of time. A bigger dot means that more letters were sent from this location during the indicated period."%}![TK]({{site.url}}/assets/img/v07/maekelberg/figure5.png)
{% endfigure %}
