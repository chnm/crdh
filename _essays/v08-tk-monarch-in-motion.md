...
{% figure caption: "Figure 1: Christian IV`s writing room on the ground floor of one of the towers of Rosenborg Castle © Photograph by Marie Thérèse Hébert & Jean Robert Thibault, 25 May 2016. Licensed under CC BY-SA 2.0. Via Wikimedia Commons"%}![TK]({{site.url}}/assets/img/v07/maekelberg/figure1.png)
{% endfigure %}
...
{% figure caption: "Figure 2: a letter written by Christian IV and signed with D'ronningborre Slott den 4 Maÿ Anno D(omi)ni 1610 Christian'. © Rigsarkivet København, Kongehuset Christian 4., Christian 4.s egenhændige breve."%}![TK]({{site.url}}/assets/img/v07/maekelberg/figure2.png)
{% endfigure %}
...
{% figure caption: "Figure 3: A map indicating the location from where the letters were written. This shows the mobility of Christian IV throughout the Danish territory."%}![TK]({{site.url}}/assets/img/v07/maekelberg/figure2.png)
{% endfigure %}
...
{% figure caption: "Figure 5: Visualization of the correspondence split up into relative periods of time. A bigger dot means that more letters were sent from this location during the indicated period."%}!({{site.url}}/assets/img/v07/maekelberg/figure5a.png)!({{site.url}}/assets/img/v07/maekelberg/figure5b.png)!({{site.url}}/assets/img/v07/maekelberg/figure5c.png)!({{site.url}}/assets/img/v07/maekelberg/figure5d.png)!({{site.url}}/assets/img/v07/maekelberg/figure5e.png)!({{site.url}}/assets/img/v07/maekelberg/figure5f.png)
{% endfigure %}
...
{% figure caption: "Figure 6: A map of the locations mentioned in the body text of the letters of Christian IV. A larger area of Europe is now covered, including England and Spain"%}![TK]({{site.url}}/assets/img/v07/maekelberg/figure6.png)
{% endfigure %}
...
{% figure caption: "Figure 7: Some of the most important building sites of Christian IV"%}![TK]({{site.url}}/assets/img/v07/maekelberg/figure7.png)
{% endfigure %}
